...
function Timer  ({currentSeconds, startTimer, stopIntervalFunc} : {currentSeconds: Number, startTimer: MouseEventHandler<HTMLButtonElement>, stopIntervalFunc: MouseEventHandler<HTMLButtonElement>})  {
